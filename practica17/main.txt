...
shx, shy = 0.5, 0.3
matriz_sesgado = np.array([[1, shx, 0], [shy, 1, 0], [0, 0, 1]])

matriz_total = (
    matriz_transformacion @ matriz_escalado @ matriz_reflexion_x @ matriz_sesgado
)
...
plt.plot(
    ...
    puntos_finales[:, 1],
    "co-",
    label="Transformado(Sesgado + Reflexion + Escalado + Rotacion + Traslacion)",
)
...
plt.ylabel("Eje Y")
plt.title(
    "Transformacion Matricial (Sesgado + Reflexion + Escalado + Rotacion + Traslacion)"
)
