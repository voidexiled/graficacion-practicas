...
matriz_total = matriz_transformacion @ matriz_escalado
...
plt.plot(
    ...
    puntos_finales[:, 1],
    "go-",
    label="Transformado(Escalado + Rotacion + Traslacion)",
)
...
plt.xlabel("Eje X")
plt.ylabel("Eje Y")
plt.title("Transformacion Matricial (Escalado + Rotacion + Traslacion)")
